...
export const fetchRoutesList = (): Promise<TourRoute[]> =>
  new Promise<TourRoute[]>((resolve, reject) => {
    console.log("env: ", process.env.REACT_APP_DEV_RUN);

    api
      .get<TourRouteResponse[]>("routes/")
      .then((value) => {
...
export const fetchRouteData = (pk: number): Promise<TourRoute> =>
  new Promise<TourRoute>((resolve, reject) => {
    api
      .get<TourRouteResponse>(`routes/${pk}/`)
      .then((response) => {
...
export const repostRouteData = (route: TourRoute): Promise<TourRoute> =>
  new Promise<TourRoute>((resolve, reject) => {
    api
      .post<TourRouteResponse>(`routes/repost/${route.pk}/`, route.packData())
...
export const createTourRoute = (
  ...
  new Promise((resolve, reject) => {
    api
      .post<TourRouteResponse>("routes/", args)
      .then((response) => resolve(TourRoute.fromApiResponse(response.data)))
      .catch((reason) => {
...
export const deleteTourRoute = (id: Number): Promise<boolean> =>
  new Promise((resolve, reject) => {
    api
      .delete(`routes/${id}/`)
      .then((response) => {
