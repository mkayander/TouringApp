...
function App() {
  const startPos = new LatLng(55.4331145, 37.556291);
  ...
  return (
    <>
      ...
      <Container>
        ...
        <div style={{ display: "flex", flexFlow: "row wrap" }}>
          <Toolbar>
            ...
            <ToolButton
              label={"Переместить целевые точки"}
              icon={<FaHandHolding />}
      ...
      <Overlay
        active={modalHook.activeModal !== null}
        onClick={() => {
